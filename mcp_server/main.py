...
def employees_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[EmployeesFilter] = None,
    sort: Optional[EmployeesSort] = None,
    fields: Optional[str] = None,
):
    """
    List Employees
...
@app.get(
    ...
    tags=['job_info_retrieval', 'employee_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def payrolls_all(
    ...
    x_apideck_app_id: str = Header(..., alias='x-apideck-app-id'),
    x_apideck_service_id: Optional[str] = Header(None, alias='x-apideck-service-id'),
    filter: Optional[PayrollsFilter] = None,
    fields: Optional[str] = None,
):
    """
    List Payroll
...
@app.get(
    ...
    tags=['employee_record_management', 'payroll_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['payroll_operations', 'employee_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['employee_schedule_operations', 'employee_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['time_off_requests_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def time_off_requests_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[TimeOffRequestsFilter] = None,
    fields: Optional[str] = None,
):
    """
